...
export const setStartingMonth = (months) => {
  ...
  export const totalGlobalClientsDetail = (months, rawData, annual, project, statics, budget) => {
    let detail = []
...
export const getChurnTotalInAud = (months, monthsText, selectedMonth, forexData, lostValues) => {
  ...
  export const setStartingRRValues = churnTer => {
		let totalDataRR = 0
...
//  export const revenueTotals = (months, rawData, churnTer, totalDataRR) => {
//     const ausTotal = []
//     const canTotal = []
//     const usaTotal = []
//     const ukTotal = []
